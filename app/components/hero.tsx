export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden topo-lines">
      {/* Gradient overlay */}
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center pt-24">
        ...
        <div className="mt-10 animate-slide-up" style={{ animationDelay: "0.2s" }}>
          <div className="inline-flex items-center gap-3 rounded-xl border border-copper/30 bg-copper/5 px-6 py-3">
            ...
            <span className="text-sm sm:text-base text-off-white/60">
